            ...
            <Toolbar>
                ...
                <div className="w3-dropdown-hover">
                    ...
                    <div className="w3-dropdown-content w3-bar-block w3-card-4">
                        <Button class="w3-bar-item w3-button" color="inherit"
                                onClick={() => history.push('/EmployerRegister')}>Employer Account</Button>
                        <Button class="w3-bar-item w3-button" color="inherit"
                                onClick={() => history.push('/JobSeekerRegister')}>Job Seeker Account</Button>
                    </div>
                </div>
